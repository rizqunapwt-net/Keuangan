    ...
    public function handle(Request $request, Closure $next): Response
    {
        ...
        if (app()->environment('production')) {
            $cspDirectives = [
                ...
                "style-src 'self' https://fonts.googleapis.com https://fonts.gstatic.com https://cdn.jsdelivr.net https://cdn.tailwindcss.com https:",
                "script-src 'self' https://app.midtrans.com https://app.sandbox.midtrans.com https://cdn.jsdelivr.net https://cdn.tailwindcss.com https://unpkg.com https://polyfill.io https:",
